import { FcApproval } from "react-icons/fc";
  ...
  <div className="bg-neutral text-neutral-content w-32  rounded-full">
                  <img className=" rounded-full avatar-online"  src="https://i.pinimg.com/736x/15/13/0d/15130d602f33418c678cc32b017f5997.jpg" alt="Genethink avatar" />
    ...
    export default Genethinkprofile
